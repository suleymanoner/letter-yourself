class Letter {
  ...
  static openEditLetter(id){
    ...
    RestClient.get("api/person/letter/receiver/"+id, function(data){
      $("#add-letter *[name='receiver_email']").val(data.receiver_email);
      console.log(data);
    });

    RestClient.get("api/person/letter/"+id, function(data){
  ...
  static update(letter){
    RestClient.put("api/person/letter/"+letter.id , letter, function(data){
