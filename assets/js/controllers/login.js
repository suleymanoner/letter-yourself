class Login {
  ...
  static doRegister(){
    ...
    RestClient.post("api/register", Utils.jsonize_form("#register-form"), function(data){
      $("#register-form-container").addClass("hidden");
  ...
  static doLogin(){
    ...
    RestClient.post("api/login", Utils.jsonize_form("#login-form"), function( data ) {
  ...
  static doForgotPassword(){
    ...
    RestClient.post("api/forgot", Utils.jsonize_form("#forgot-form"), function(data) {
      $("#forgot-form-container").addClass("hidden");
      $("#form-alert").removeClass("hidden")
      $("#form-alert .alert").html(data.message);
    }, function(jqXHR, textStatus, errorThrown) {
  ...
  static doChangePassword(){
    ...
    RestClient.post("api/reset", Utils.jsonize_form("#change-form"), function(data) {
      window.localStorage.setItem("token", data.token);
      window.location = "index.html";
    }, function(jqXHR, textStatus, errorThrown) {
